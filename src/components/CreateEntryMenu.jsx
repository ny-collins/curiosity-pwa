...
const CreateMenuPanel = ({ open, handleCreateEntry }) => {
    ...
    return (
        ...
        >
            <Popover.Panel className="absolute z-[100] w-72 mt-2 -translate-x-1/2 left-1/2 sm:left-auto sm:translate-x-0 sm:w-80 bg-white dark:bg-slate-800 rounded-xl shadow-2xl ring-1 ring-black/5 dark:ring-white/10 focus:outline-none overflow-hidden backdrop-blur-sm border-2 border-slate-200 dark:border-slate-700">
                <div className="p-2">
